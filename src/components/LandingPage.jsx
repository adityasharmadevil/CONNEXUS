...
function LandingPage() {
  ...
  // Dummy login check (you can replace with actual logic like token check)
  ...
  const handleMakeCall = () => {
    if (isLoggedIn) {
      ...
      setShowLoginAlert(true); // Show alert modal
    }
  };
  ...
  return (
    <div
      className='content w-full h-[100vh] flex flex-col items-center justify-center '
