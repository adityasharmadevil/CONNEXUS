  ...
  return (
    <div className='content w-full h-[100vh] flex flex-col items-center justify-center bg-[url("src/assests/bgimage.jpg")]'>
        ...
        <div className='w-full py-2 flex justify-center'>
          <button className='h-[6vh] w-[15vw] rounded-lg bg-[#1B9AAA] font-[Poppins] hover:shadow-lg shadow-[#1B9AAA] hover:text-white' onClick={handleMakeCall} >Make a Call </button>
        </div>
    </div>
  )
}
